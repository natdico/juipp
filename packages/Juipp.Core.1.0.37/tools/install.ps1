...
$path11 = "`$(MSBuildExtensionsPath32)\Microsoft\VisualStudio\v11.0\TextTemplating\Microsoft.TextTemplating.targets"
...
Write-Host "Added Property Group > OrgJuippT4Properties"
